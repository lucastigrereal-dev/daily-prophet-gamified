...
function parseCSV(content) {
  ...
  console.log(`   # Index: ${numeroIdx}`);
  console.log(`   Tipo Post: ${tipoPostIdx}`);
  console.log(`   Conteudo: ${conteudoIdx}`);
  console.log(`   Headlines: ${headlinesIdx}`);
  console.log(`   Reels: ${reelsIdx}`);
  console.log(`   Carrossel: ${carrosselIdx}`);
  console.log(`   Legenda: ${legendaIdx}`);
  console.log(`   CTAs: ${ctasIdx}`);
  console.log(`   Hacks: ${hacksIdx}\n`);
...
function transformPost(csvPost) {
  return {
